...
data.ModMapLabels = {
	...
	["\\CamdenCountyB42"] = {
		...
		{ key = "MapLabel_Alton",          x = 15543,  y = 9949, type = "Town", scale = 4.0 },
		{ key = "MapLabel_CampLynn",          x = 17315,  y = 9446, type = "Place",scale = 1.0},
		{ key = "MapLabel_DixieHomes",          x = 15161,  y = 9487, type = "Place",scale = 1.0},
		...
		{ key = "MapLabel_Robinsville",          x = 15427,  y = 10827, type = "Place", scale = 1.3 },
		{ key = "MapLabel_SouthIngles",          x = 16546,  y = 13477, type = "Town", scale = 3.0 },
		{ key = "MapLabel_Suggs",          x = 17100,  y = 11650, type = "Town", scale = 4.0 },
		{ key = "MapLabel_Trenton",          x = 16274,  y = 9392, type = "Place",scale = 1.0},
