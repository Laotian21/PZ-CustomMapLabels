...
data.VanillaMapLabels = {
	["Vanilla"] = {
		...
		{ key = "MapLabel_StorageUnitSelfStorageWestPoint",	x = 12136,  y = 7021, type = "Building", scale = 0.2 },		
		{ key = "MapLabel_StorageUnitStoreAMaxMuldraugh",	x = 10757,  y = 10353, type = "Building", scale = 0.2, rotation = 90.0 },
